...
<body style="background-image: linear-gradient(200deg, #D5DBDB, #FAE5D3 , #D7BDE2, #D4E6F1, #D5DBDB); background-attachment: fixed; background-repeat: no-repeat; background-size: 100vw 100vh;">
    ...
    <div class="container">
        <div class="row mt-3">
            ...
            <a href="registrar_cartas.php" class="col-md-4 h3 text-right animated slideInDown text-secondary text-decoration-none">Volver a registrar cartas</a>
            ...
            foreach ($datos as $dato) {
                echo '<div class="card col-md-3 animated fadeIn delay-1s m-2" style="background: none; border: 3px solid white;">
                            <img src="' . $dato->link . '" alt="imagen" class="card-img-top img-thumbnail mt-3 p-2">
                            <div class="card-body">
