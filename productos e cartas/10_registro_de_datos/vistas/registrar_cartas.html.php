...
<body style="background-image: linear-gradient(20deg, #F2D7D5, #F5B7B1 , #D7BDE2); background-attachment: fixed; background-repeat: no-repeat; background-size: 100vw 100vh;">
    ...
    <div class="container">
        <div class="row my-5 text-center animated fadeIn">
            ...
            <form action="" method="post" class="mx-auto p-5 border col-md-6" style="background-color: white;">
                ...
                <div class="form-group">
                    <input type="url" name="link" id="link" placeholder="Link de la imagen" class="form-control" value="<?php if (isset($_POST['link'])) echo $_POST['link']; ?>">
                    <?php
