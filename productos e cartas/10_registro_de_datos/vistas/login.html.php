...
<body style="background-image: linear-gradient(20deg, #D6DBDF, #D0ECE7, #D1F2EB ); background-attachment: fixed; background-repeat: no-repeat; background-size: 100vw 100vh;">
    <div class="container">
        <div class="row">
            <form class="form-signin my-3 border rounded col-md-5 mx-auto animated bounceIn" method="post" style="background-color: white;">
                ...
                <div class="row">
                    <button class="btn btn-md btn-outline-secondary col-md-9 mx-auto" type="submit" name="login">Iniciar sesión</button>
                </div>
